...
def generate_start_keyboard():
    ...
    keyboard.add(InlineKeyboardButton("Open Crowdy App", web_app=WebAppInfo(url="https://crowdyfrontend.netlify.app/")))
    return keyboard
    ...
    try:
        ...
        if not user_doc.exists:
            ...
            if len(text) > 1 and text[1].startswith('ref_'):
                ...
                referrar_ref = db.collection('users').document(referrer_id)
                referrer_doc = referrar_ref.get()
                ...
                if referrer_doc.exists:
                    ...
                    current_balance = referrer_data.get('referrals', {})
